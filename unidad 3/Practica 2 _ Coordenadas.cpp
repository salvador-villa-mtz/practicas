...
int main(){
    ...
    gotoxy(1, 1); //Mueve el cursor a la posición 1, renglón 1
    cout << "Este letrero comienza en la posición (1,1).";
    gotoxy(30, 2); //Mueve el cursor a la posición 30, renglón 2
    cout << "Este letrero comienza en la posición (30,2).";
    gotoxy(1, 20); //Mueve el cursor a la posición 1, renglón 20
