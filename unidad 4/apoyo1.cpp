...
int main()
{
    ...
    int numEstu=0,t=0,suma=0,ap=0,menu=0;
	Estudiante estudiantes[3]; // numEetu=Número de estudiantes a almacenar y ap=alumnos en peligro academico
    do{
        ...
        case 1:
         do {
                ...
                cin >> numEstu;
                if (0 >= numEstu){
                    cout << "no se aceptan valores negativos o 0 teclee denuevo...\n";
                    numEstu = 6;
                }
                else{
                    if (numEstu > 3)
                    {
                        cout << "valor mayor a 5 teclee de nuevo...\n";
                    }
                }
                system("pause");
                system("cls");
            ...
            for (int i = 0; i < numEstu; i++) {
                ...
                do {
                    ...
                    if (0 > estudiantes[i].asist) {
                        cout << "no se aceptan valores negativos teclee denuevo...\n";
                        t = 0;
                        system("pause");
                        system("cls");
                    }
                    else {
                        if (estudiantes[i].asist > 20) {
                            t = 0;
                            cout << "valor mayor a 20 teclee de nuevo...\n";
                            system("pause");
                            system("cls");
                        }
                        else {
                ...
                for (int j = 0; j < 3; j++){
                    do{
                        ...
                        if (0 > estudiantes[i].calificaciones[j]){
                            cout << "no se aceptan valores negativos teclee denuevo...\n";
                            t = 0;
                            system("pause");
                            system("cls");
                            ...
                            if (estudiantes[i].calificaciones[j] > 100) {
                                t = 0;
                                cout << "valor mayor a 100 teclee de nuevo...\n";
                                system("pause");
                                system("cls");
                            }
                            else{
        ...
        case 2:
            if (numEstu > 0) {
                ...
                for (int i = 0; i < numEstu; i++){
                    ...
                    if (estudiantes[i].asist == 0){
                        cout << "Asistencias: 0" << "% ";
                    }
                    else {
                        cout << "Asistencias: " << estudiantes[i].asist / 0.2 << "% ";
                    }
                    ...
                    if ((suma / 3) < 70){
                        cout << "--->en situacion de riesgo academico por promedio";
                    }
                    else
                    {
                        if ((estudiantes[i].asist / 0.2) < 80){
                            cout << "--->en situacion de riesgo academico por inasistencia";
                        }
                        else{
                            cout << "--->todo bien siga asi :)";
                        }
                    }
                    if ((estudiantes[i].asist / 0.2) < 80){
                        cout << "--->en situacion de riesgo academico por inasistencia";
                    }
                    if ((estudiantes[i].asist / 0.2) < 80 or (suma / 3) < 70) {
                        ap = ap + 1;
                    }
                    cout << "\n";
                    suma = 0;
